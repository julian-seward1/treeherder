...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not failure_lines:
            logger.debug("No failures lines")
            return
        ...
        summary = TextLogSummary(job_guid=job_guid,
                                 repository=repository,
                                 text_log_summary_artifact_id=text_log_summary["id"],
                                 bug_suggestions_artifact_id=bug_suggestions["id"])
        ...
        assert match_iter.next() == (None, None)
